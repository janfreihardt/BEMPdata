...
If you use this dataset please cite both the data descriptor and the Zenodo
deposit:

> Freihardt, J. et al. (*forthcoming*). Bangladesh Environmental Mobility
> Panel (BEMP). *[Journal]*. DOI: [to be added]

> Freihardt, J. et al. (2026). Bangladesh Environmental Mobility Panel
> (BEMP) [Dataset]. Zenodo. <https://doi.org/10.5281/zenodo.18229498>
